  ...
  return (
    <Switch>
      ...
      <Route path="dashboard" element={<Protected allow={isAuthenticated} to="/auth" />}>
        <Route path="users" element={<Dashboard.Users refresh={refresh} />} />
        <Route path="devices" element={<Dashboard.Devices />} />
        <Route index path="*" element={<Navigate to="/dashboard/users" />} />
      </Route>
